            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div><p className="text-xs text-slate-500 uppercase tracking-wider font-bold">{t.contact.whatsapp}</p><p className="font-medium text-slate-100" dir="ltr">+33 7 73 98 91 12</p></div>
                </div>
              </div>
            </div>
