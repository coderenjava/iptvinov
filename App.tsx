...
const App: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen bg-slate-950 transition-colors duration-500`}>
      <Navbar lang={lang} setLang={setLang} t={t} onHomeClick={handleBackHome} />
      ...
      <main>
        {view === 'home' ? (
          ...
          <PrivacyPolicy t={t} onBack={handleBackHome} />
        )}
      </main>

      <Footer t={t} onPrivacyClick={handlePrivacyClick} />
      ...
      <div className={`fixed bottom-6 ${lang === 'ar' ? 'left-6' : 'right-6'} flex flex-col gap-4 z-50`}>
        ...
        >
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            {/* FIX: Replaced incomplete SVG path data with the full path. */}
